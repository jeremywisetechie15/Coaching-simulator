...
export const ROLEPLAY_ROUTES = {
    ...
    app: {
        ...
        personaFeedback: (roleplayId: string, sessionId: string, transcriptSessionId: string) =>
            `/iframe?scenario_id=${encodeRouteSegment(roleplayId)}&variant=coach&ref_session_id=${encodeRouteSegment(sessionId)}&transcript_session_id=${encodeRouteSegment(transcriptSessionId)}`,
        sessionCoachFeedback: (roleplayId: string, sessionId: string, transcriptSessionId: string) =>
            `/iframe?scenario_id=${encodeRouteSegment(roleplayId)}&mode=coach&coach_mode=feedback&ref_session_id=${encodeRouteSegment(sessionId)}&transcript_session_id=${encodeRouteSegment(transcriptSessionId)}`,
        sessionDebrief: (roleplayId: string, sessionId: string, transcriptSessionId: string) =>
            `/iframe?scenario_id=${encodeRouteSegment(roleplayId)}&mode=coach&coach_mode=notation&ref_session_id=${encodeRouteSegment(sessionId)}&transcript_session_id=${encodeRouteSegment(transcriptSessionId)}`,
        ...
        session: (roleplayId: string) => `/roleplays/${encodeRouteSegment(roleplayId)}/session`,
