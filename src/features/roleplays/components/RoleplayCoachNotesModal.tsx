...
export interface RoleplayCoachNotesViewerProps {
    groups: RoleplayCoachNoteGroup[];
    onGroupSaved?: (group: RoleplayCoachNoteGroup) => void;
    roleplayId: string;
}

interface RoleplayCoachNotesModalProps extends RoleplayCoachNotesViewerProps {
    onClose: () => void;
    title: string;
}

/** Liste éditable des notes, réutilisable dans une modal dédiée ou un onglet de préparation. */
export function RoleplayCoachNotesViewer({
    groups,
    onGroupSaved,
    roleplayId,
}: RoleplayCoachNotesViewerProps) {
