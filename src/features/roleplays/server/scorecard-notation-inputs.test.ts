...
describe("scorecard notation inputs", () => {
    it("provides complete business context and generic refs to the methodo call", () => {
        ...
        expect(input).toContain("Ne force jamais une correction");
        expect(input).toContain("erreurs probables de transcription automatique");
        expect(input).toContain("En cas de doute entre une erreur de l'Apprenant et une erreur de transcription");
        expect(input).toContain("jamais sur une simple correction linguistique");
        ...
        expect(input).toContain("au maximum 2 corrections sur l'ensemble des criteres");
