export const uiTokens = {
    ...
    filterBar: {
        ...
        librarySelectCompanySize: "w-[220px]",
        librarySelectDisc: "w-[188px]",
        librarySelectDomain: "w-[180px]",
        librarySelectAge: "w-[170px]",
        librarySelectLevel: "w-[156px]",
        librarySelectMethod: "w-[210px]",
        librarySelectPcs: "w-[250px]",
        librarySelectSector: "w-[230px]",
        librarySelectSex: "w-[150px]",
