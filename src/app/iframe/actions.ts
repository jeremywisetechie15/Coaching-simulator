...
export interface IframeSessionConfig {
    ...
    voiceId: string;
    mode: "standard" | "coach";
    coachMode?: "before_training" | "after_training" | "default" | "persona_variant";
    model: string;
    personaName: string;
    avatarUrl?: string;
}
...
// =============================================
// PROMPTS DE BASE POUR CHAQUE MODE
// =============================================

// Prompt #2: Mode coach AVANT entraînement (preparation, sans transcript)
const COACH_BEFORE_TRAINING_PROMPT = `Tu es un coach professionnel qui prépare l'utilisateur AVANT une session d'entraînement.
...
// Prompt #3: Mode coach APRÈS entraînement (débrief avec transcript et focus étape)
const COACH_AFTER_TRAINING_PROMPT = `Tu es un coach professionnel expert en débrief de sessions d'entraînement.
    ...
    try {
        ...
        if (mode === "coach") {
            ...
            if (coachMode === "before_training") {
                ...
                const systemInstructions = `${COACH_BEFORE_TRAINING_PROMPT}
...
`;
            ...
            if (coachMode === "after_training") {
                ...
                const systemInstructions = `${COACH_AFTER_TRAINING_PROMPT}
...
Après notre dernière conversation, tu donnes ton avis et ton ressenti EN TANT QUE ${persona.name} :
...
- Tes conseils en tant que ${persona.name}
...
`;
            ...
            console.log("📝 Persona variant mode - Persona gives feedback:", persona.name);
