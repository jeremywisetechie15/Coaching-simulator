-- Scorecard v2: the model identifies evidence by transcript message reference.
-- The application resolves those references against the current session and
-- persists the exact learner messages. Historical notation_json is untouched.
begin;
